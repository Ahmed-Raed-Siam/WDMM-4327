    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <div class="footer_makes_sub_font"> Dec 31, 2016</div>
                <a href="#" class="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
                <div class="footer_position_absolute"><img src='{{ asset('images/footer_sub_tipik.png') }}' alt="img"
                                                           class="width_footer_sub_img"/></div>
            </div>
            <div class="col-12 col-md-12 col-lg-4 ">
                <div class="footer_main_title py-3"> Last Modified Posts</div>
                <a href="#" class="footer_img_post_6"><img src='{{ asset('images/allef-vinicius-108153.jpg') }}'
                                                           alt="img"/></a>
                ...
                <a href="#" class="footer_img_post_6"><img src='{{ asset('images/science-578x362.jpg') }}'
                                                           alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src='{{ asset('images/vil-son-35490.jpg') }}' alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src='{{ asset('images/zack-minor-15104.jpg') }}'
                                                           alt="img"/></a>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href='{{ url("Contact_us.html") }}' class="footer_last_part_menu">About</a>
                <a href='{{ url("Contact_us.html") }}' class="footer_last_part_menu">Contact</a>
                <a href='{{ url("blog.html") }}' class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
